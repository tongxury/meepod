...
// Erc20TransferIterator is returned from FilterTransfer and is used to iterate over the raw logs and unpacked data for TransferTrc20 events raised by the Erc20 contract.
...
// Erc20Transfer represents a TransferTrc20 event raised by the Erc20 contract.
...
//
// Solidity: event TransferTrc20(address indexed from, address indexed to, uint256 value)
func (_Erc20 *Erc20Filterer) FilterTransfer(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*Erc20TransferIterator, error) {
	...
	logs, sub, err := _Erc20.contract.FilterLogs(opts, "TransferTrc20", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &Erc20TransferIterator{contract: _Erc20.contract, event: "TransferTrc20", logs: logs, sub: sub}, nil
}
...
func (_Erc20 *Erc20Filterer) WatchTransfer(opts *bind.WatchOpts, sink chan<- *Erc20Transfer, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Erc20.contract.WatchLogs(opts, "TransferTrc20", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _Erc20.contract.UnpackLog(event, "TransferTrc20", log); err != nil {
					return err
				}
				event.Raw = log
