...
const (
	...
	// ArrayMarshallerType indicates that the field carries an ArrayMarshaler.
	ArrayMarshallerType
	// ObjectMarshallerType indicates that the field carries an ObjectMarshaler.
	ObjectMarshallerType
	...
	Complex64Type
	// DurationType indicates that the field carries a mtime.Duration.
	DurationType
	...
	StringType
	// TimeType indicates that the field carries a mtime.Time.
	TimeType
...
func Strings_(key string, val ...string) Field {
...
func UserIDs(userIDs []string) Field {
	return Strings("userIDs", userIDs)
}
...
// controls how the mtime is serialized.
