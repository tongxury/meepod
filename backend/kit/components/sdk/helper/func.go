...
func Select(expect bool, trueValue interface{}, falseValue interface{}) interface{} {
	if expect {
		return trueValue
	}
	return falseValue
...
func SelectString(expect bool, trueValue string, falseValue string) string {
	return Select(expect, trueValue, falseValue).(string)
}

func SelectInt64(expect bool, trueValue int64, falseValue int64) int64 {
	return Select(expect, trueValue, falseValue).(int64)
}
