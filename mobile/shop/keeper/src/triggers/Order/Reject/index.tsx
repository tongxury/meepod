...
const RejectTrigger = ({onConfirm, children, style}: {
    onConfirm?: (id) => void,
    ...
    return <View style={style}>
        {children && <Pressable children={children} onPress={() => setVisible(true)}/>}
        {!children && <RneButton size={'sm'} color={colors.error} onPress={() => setVisible(true)}>拒单</RneButton>}
        <Portal>
