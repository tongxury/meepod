...
const Z6SelectorView = ({onConfirm}: {
    ...
    const updateAmount = () => {
        setAmount((cnm(selectedTon.length, 3)) * 2)
    }
    ...
    const validPlan = selectedTon.length >= 3
